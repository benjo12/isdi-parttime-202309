...
db.users.insert(new User(null, 'Benjamin Charles', 'benji@charles.com', '1234',[]))

db.posts.insert(new Post(
    null,
    db.users.documents[2].id,
    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQL85dIgd0qz_z2cVn-l_M5yrYG-YBIVMAR2w&usqp=CAU',
    "Let's gooo!",
